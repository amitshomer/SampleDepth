...
2. All reconstructed depth maps should be saved for all datasets (train and evaluation). This code should be run after manually adding the train loader after plotting the eva loader:
```
...
4. You should save all the prediction output from PredNet prior to running SampleDepth with PredNet. This code should be run after manually adding the train loader after plotting the eva loader:
```
